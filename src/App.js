...
if (TZINFO_API_URL) {
  // TZInfo.org URL is available for future use; the clock uses the browser's
  // native Intl.DateTimeFormat API with IANA timezone identifiers (the TZ
  // database maintained by TZInfo.org) and does not make external API calls.
